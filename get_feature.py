...
def main():
    ...
    torch.save(a, "/mnt/traffic/home/pankun/FF++/Deepfake-Detection-master/Deepfakes_Memory_set/myTensor_sum.pt")
    b = torch.load("/mnt/traffic/home/pankun/FF++/Deepfake-Detection-master/Deepfakes_Memory_set/myTensor_sum.pt")
    print(b.shape)
...
if __name__ == '__main__':
    ...
    parse.add_argument('--test_list', '-tl', type=str, default='/mnt/traffic/home/pankun/FF++/Deepfake-Detection-master/Deepfakes_Memory_set/sum_20221215.txt')
    #parse.add_argument('--model_path', '-mp', type=str, default='./pretrained_model/df_c0_best.pkl')
    parse.add_argument('--model_path', '-mp', type=str, default='/mnt/traffic/home/pankun/FF++/Deepfake-Detection-master/output/train_by_Deepfakes/best.pkl')
