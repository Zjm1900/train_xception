...
if __name__ == '__main__':
    ...
    parse.add_argument('--train_list', '-tl' , type=str, default = '/home/zhongjieming/train_xception/fake_test.txt')
    ...
    parse.add_argument('--model_path', '-mp', type=str, default='/home/zhongjieming/train_xception/pretrain_model/xception-b5690688.pth')
